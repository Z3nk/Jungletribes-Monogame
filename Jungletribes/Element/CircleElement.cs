...
namespace Jungletribes
{
    public class CircleElement : Element
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                JungleTribesGame.Instance.spriteBatch.Draw(Circle_Texture, new Rectangle((int)this.position.X, (int)this.position.Y, Circle_Texture.Width, Circle_Texture.Height), Color.White);
            ...
            JungleTribesGame.Instance.spriteBatch.Draw(C2, new Rectangle((int)Pipe.MousePosition.X-C2.Width/2, (int)Pipe.MousePosition.Y - C2.Height / 2, C2.Width, C2.Height), Color.White);
        }
