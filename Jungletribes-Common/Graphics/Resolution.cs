...
namespace Jungletribes_Common
{
    public static class Resolution
    {
        ...
        static public void BeginDraw()
        {
            ...
            FullViewport();
            // Clear to Black
            _Device.GraphicsDevice.Clear(Color.Violet);
        ...
        static public float AdjustWidthWithScren(float i)
        {
            return i / getTransformationMatrix().M11;
        }

        static public float AdjustHeightWithScren(float i)
        {
            return i / getTransformationMatrix().M22;
        }
